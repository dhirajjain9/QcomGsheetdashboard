...
RULES = [
    ...
    ("All-Purpose Cleaner", ["all purpose cleaner", "cleaner spray", "floor cleaner", "disinfectant", "tile cleaner", "surface cleaner", "wd-40", "wd40"]),
    ...
    ("Cloth Clip / Peg", ["cloth clip", "cloth peg", "clothes peg", "clip -", "clips", " peg "]),
    ...
    ("Storage Bag / Pouch", ["storage bag", "zip lock", "ziplock", "drawstring", "storage pouch", "fridge bag", "potli", "toiletry bag", "toiletry pouch", "travel pouch", "cosmetic bag", "cosmetic pouch", "compression pouch", "makeup pouch", "vanity bag", "travel bag", "sling bag", "wine bag", "luggage", "blanket storage"]),
    ...
    ("Dough Press / Maker", ["dough press", "samosa", "samosha", "gujiya", "karanji", "puran machine", "kachori", "modak maker"]),
    ("Funnel", ["funnel"]),
    ...
    ("Cookware / Pan", ["kadai", "kadhai", "roaster", "frying pan", "fry pan", "tawa", "saucepan", "cookware", "wok", "skillet", "multi pan"]),
    ("Casserole", ["casserole", "serving pot", "hot pot", "hot case"]),
    ("Lunch Box / Tiffin", ["lunch box", "lunchbox", "tiffin", "meal box"]),
    ("Lunch Set", ["lunch set"]),
    ...
    ("Dinner Set / Plate", ["dinner set", "dinner plate", "plate set", "quarter plate", "thali", "platter", "meal set", "kids meal", "chip n dip", "chip and dip", "opalware", "plate"]),
    ("Serving Tray", ["tray"]),
    ("Jar / Canister", ["jar", "canister"]),
    ("Storage Container", ["container", "containers"]),
    ("Spice Box", ["spice box", "masala box", "masala dabba"]),
    ("Cutlery Holder / Caddy", ["cutlery holder", "cutlery caddy"]),
    ("Ladle / Skimmer", ["ladle", "skimmer", "cooking spoon"]),
    ("Cutlery (Spoon/Fork)", ["spoon", "fork", "cutlery", "server set", "cake knife"]),
    ("Knife", ["knife", "knives"]),
    ("Chopping Board", ["chopping board", "cutting board"]),
    ("Chopper / Peeler / Grater", ["chopper", "cutter", "slicer", "grater", "peeler"]),
    ...
    ("Trivet / Pot Holder", ["trivet", "pot holder", "pot stand", "cork pot"]),
    ("Jug", ["jug"]),
    # --- Storage / bags / covers ---
